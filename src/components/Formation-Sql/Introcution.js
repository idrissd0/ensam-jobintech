        ...
        <div id="Introduction">
            ...
            <div className="ProgrammFormation">
                ...
                <div className="FormationInfo container">
                    <ul>
                            <li className="FirstHeader"><h6>Développeur web service</h6>
                                <ul>
                                        <li>Décrire les aspects physiques et les aspects théoriques d’une base de données relationnelle</li>
                                        <li>Décrire l’implémentation Oracle des SGBDR et des SGBD orientés objet</li>
                                        <li>Ecrire des instructions SQL SELECT élémentaires</li>
                                        <li>Limiter le nombre de lignes extraites par une interrogation</li>
                                        <li>Décrire différents types de fonction SQL</li>
                                        <li>Écrire des instructions SELECT pour accéder aux données de plusieurs tables en utilisant des équijointures et des non-équijointures</li>
                                        <li>Regrouper des données à l’aide de la clause GROUP BY</li>
                                        <li>Inclure ou exclure des groupes de lignes à l’aide de la clause HAVING</li>
                                        ...
                                        <li>Créer des rôles afin de faciliter la configuration et la maintenance du modèle de sécurité</li>
                                        <li>Accorder et retirer des privilèges objet à l’aide des instructions GRANT et REVOKE</li>
                                 </ul>
                            </li>
                            ...
                            <li className="FirstHeader">
                                    <h6>UML & java</h6>
                                <ul>
                               <li> Technique de modélisation et de conception d’un système industriel multidisciplinaire à l’aide d’UML et de SysML</li>
                               <li> La modélisation statique : le diagramme de classes, la notion de classe et d’objet, les attributs, les opérations, les relations d’association, les relations de généralisation/héritage</li>
                               <li> La modélisation dynamique : Diagramme de séquences, de collaboration, d’état et d’activité, notion de messages synchrones/asynchrones, Modélisation de la communication entre objets avec le diagramme de séquence, diagramme de déploiement et de composant</li>
                              <li>  Les éléments du langage JAVA et manipulation des classes et objets</li>
