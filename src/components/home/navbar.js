          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0  d-flex align-items-center m-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown-item">
                      <a onClick={userSignOut} class="dropdown-item" href="#">
                        Logout
                      </a>
                    </li>
                  </ul>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a class="dropdown-item" href="/formation-fullstack">
                      Développement Fullstack PHP
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="/formation-sql">
                      AData SQL Webservices
                    </a>
                  </li>
                </ul>
              </li>
